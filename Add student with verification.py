...
l=lastname.get_attribute('value')
print("Last name entered is:",l)
time.sleep(8)
...
#Click the added students name
driver.find_element(By.CSS_SELECTOR,value="body > table:nth-child(5) > tbody:nth-child(1) > tr > td > table:nth-child(11) > tbody > tr > td > table > tbody > tr > td > div > table:nth-child(9) > tbody:nth-child(1) > tr > td > table > tbody > tr:nth-child(5) > td > table > tbody > tr:nth-child(2) > td:nth-child(2) > table > tbody > tr > td > a").click()
time.sleep(5)
#Click edit student button
driver.find_element(By.LINK_TEXT,value="Edit Student").click()
time.sleep(10)
last_name=driver.find_element(By.NAME,value="Lname")
newlastname=last_name.get_attribute('value')
if(l==newlastname):
    print("Last name entered is:",l,"which matches with:",newlastname,".So TC passed")
else:
